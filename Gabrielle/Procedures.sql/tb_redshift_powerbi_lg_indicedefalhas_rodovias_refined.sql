CREATE OR REPLACE PROCEDURE cntcar_work.spr_redshift_powerbi_lg_indicedefalhas_rodovias()
 LANGUAGE plpgsql
AS $$

/*  
Nome de quem criou: Matheus Fernandes Marques
Qual o objetivo ou painel que a proc será usado: Dados referente a indice de falhas de rodovias - Logística
Data de criação: 
Nome de quem alterou: Gabrielle Silva de Paula
Data de alteração: 23/10/2023
...
drop table if exists cntcar_work.tb_redshift_powerbi_lg_indicedefalhas_rodovias_refined; 
...
select
    ...
    ,fabricante
    ,descricao_modelo
into cntcar_work.tb_redshift_powerbi_lg_indicedefalhas_rodovias_refined
from base
